...
- [SDEWAN Implementation](#sdewan-implementation)
  - [SDEWAN CNF](#sdewan-cnf)
  - [SDEWAN CRD Controller](#sdewan-crd-controller)
  - [Custom Resources (CRs)](#custom-resources-crs)
- [CNF Configuration via CRs](#cnf-configuration-via-crs)
  - [IPSec](#ipsec)
- [SDEWAN CNF Packet Flow](#sdewan-cnf-packet-flow)
- [OpenNESS Integration](#openness-integration)
  - [Goals](#goals)
  - [Networking Implementation](#networking-implementation)
  - [SDEWAN Architectures](#sdewan-reference-architectures)
    - [SDEWAN Edge Reference Architecture](#sdewan-edge-reference-architecture)
    - [SDEWAN Hub Reference Architecture](#sdewan-hub-reference-architecture)
...
These plugins support the following functionality:
